        ...
        <div className="footer-links-container">
          <div className="footer-container1">
            <div className="footer-product-container">
              ...
              <span className="footer-text03">{props.text3}</span>
              <span className="">{props.text4}</span>
            </div>
            <div className="footer-company-container">
              <span className="footer-text05">{props.text5}</span>
              <span className="footer-text06">{props.text6}</span>
              <span className="footer-text07">{props.text7}</span>
              <span className="footer-text08">{props.text8}</span>
          ...
          <div className="footer-container2">
            ...
            <div className="footer-socials">
              <span className="footer-text13">{props.text13}</span>
